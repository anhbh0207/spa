...
<head>
    ...
    <style>
        ...
        .topbar { height:50px; background:#fff; border-bottom:1px solid #e5e7eb;
        ...
        .btn { padding:6px 10px; border-radius:999px; border:none; font-size:13px;
        ...
        .form-group label { display:block; margin-bottom:4px; color:#4b5563; }
        .form-group input, .form-group select {
            width:100%; padding:6px 8px; border-radius:8px; border:1px solid #d1d5db; font-size:13px;
        }
        .form-actions { margin-top:16px; display:flex; gap:8px; justify-content:flex-end; }

        .logout-btn { background:#e5edff; color:#1e3a8a; border-radius:999px; padding:6px 12px;
