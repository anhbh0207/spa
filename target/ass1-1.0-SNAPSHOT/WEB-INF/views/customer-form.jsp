...
<%@ page import="com.example.ass1.model.Customer" %>
<%@ page import="com.example.ass1.model.CustomerStatus" %>

<%
    String formMode = (String) request.getAttribute("formMode"); // create / edit
